      ...
      <div class="card">
        ...
        <div class="card-header bg-primary pb-0 pt-4 ">
          ...
          <div class="card-body">
            ...
            <div class="text-center mb-2"> 
              ...
              <?php else:  ?>
                ...
                <img class="card-img-top w-75" src="<?php  echo site_url('admin/images/usuario_sem_imagem.png')  ?>" alt="Imagem não disponivel">
          ...
          <hr>
            ...
            <a href="<?php echo site_url("admin/entregadores/editarimagem/$entregador->id") ?>" class="btn btn-outline-primary btn-sm ,mt-2 mb-2">
          ...
          <div class="mt-4">
            ...
            <?php if($entregador->deletado_em == null): ?>
              ...
              <a href="<?php echo site_url("admin/entregadores"); ?>" class="btn btn-info btn-sm " title="Voltar" > 
                <i class="mdi mdi-arrow-left btn-icon-prepend"></i> 
              </a>

            <?php else: ?>

              <a href="<?php echo site_url("admin/entregadores/desfazerexclusao/$entregador->id"); ?>" class="btn btn-dark btn-sm" title="Desfaser Exclusão"> 
