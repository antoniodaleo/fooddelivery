        ...
        <div class="card-body">
          ...
          <?php if($forma->id == 1):  ?>
            ...
            <div class="alert alert-primary" role="alert"> 
              ...
              não pode ser <span>editada ou excluida</span>, pois essa opção terá vinculada ou não o envio de 
              troco para o comprador quando o mesmo estiver no <strong>Checkout</strong>
            </div>
          ...
          <div class="mt-4">
            ...
            <?php if($forma->deletado_em == null): ?>
              ...
              <a href="<?php echo site_url("admin/formas"); ?>" class="btn btn-info btn-sm " title="Voltar" > 
                <i class="mdi mdi-arrow-left btn-icon-prepend"></i> 
              </a>

            <?php else: ?>

              <a href="<?php echo site_url("admin/formas/desfazerexclusao/$forma->id"); ?>" class="btn btn-dark btn-sm" title="Desfaser Exclusão"> 
